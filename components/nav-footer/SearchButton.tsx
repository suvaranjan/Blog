...
const SearchButton = () => {
  return (
    <KBarButton aria-label="Search">
      ...
      <div className="hidden min-w-[240px] cursor-pointer items-center justify-between rounded-md bg-gray-200 px-2 py-2 text-sm text-gray-700 hover:bg-gray-300 hover:text-black sm:flex dark:bg-neutral-800 dark:text-gray-300 dark:hover:bg-neutral-700 dark:hover:text-white">
