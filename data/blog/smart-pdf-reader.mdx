...
**Smart Pdf Reader**, yes, I decided to give this name to my recently made project. As its name is Smart Pdf Reader, you can understand it’s going to be a PDF reader web app. But when I mention "smart", then what smart feature does this web app have?
